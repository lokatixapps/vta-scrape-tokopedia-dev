              ...
              (o = [
                {
                  ...
                  value: function () {
                    ...
                    if ('function' == typeof PerfectScrollbar) {
                      ...
                      new PerfectScrollbar(o, { wheelPropagation: !1 })
                    }
                    setTimeout(function () {
                      var t
                      return null ===
                        (t = document.querySelector('.sidebar-item.active')) ||
                        void 0 === t
                        ? void 0
                        : t.scrollIntoView(!1)
                    }, 100),
                ...
                },
                {
                  key: 'createBackdrop',
                  value: function () {
                    if (!(window.body.clientWidth < 1200)) {
                      this.deleteBackdrop()
        ...
        t.exports = (function () {
          ...
          function c(t, e) {
            X[e] = setTimeout(function () {
              return (
                t.isAlive && t.element.classList.remove(L.state.scrolling(e))
              )
          ...
          function u(t, e, i, r, n) {
            var o
            if (
              (void 0 === r && (r = !0), void 0 === n && (n = !1), 'top' === e)
            )
              o = [
                'contentHeight',
                'containerHeight',
            ...
            ;(t.reach[a] = null),
              ...
              e &&
                ...
                0 > e
                  ...
                  : 0 < e && p.dispatchEvent(d('ps-scroll-' + u)),
                r && h(t, a)),
              t.reach[a] &&
                (e || n) &&
                p.dispatchEvent(d('ps-' + a + '-reach-' + t.reach[a]))
          }
          function f(t) {
          ...
          function b(t) {
            ...
            ;(t.containerWidth = i(o.width)),
              ...
              r.contains(t.scrollbarXRail) ||
                (s(r, L.element.rail('x')).forEach(function (t) {
                  return l(t)
                }),
                r.appendChild(t.scrollbarXRail)),
              r.contains(t.scrollbarYRail) ||
                (s(r, L.element.rail('y')).forEach(function (t) {
                  return l(t)
                }),
              ...
              t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                ? ((t.scrollbarXActive = !0),
                  ...
                  (t.scrollbarXLeft = f(
                    ((t.negativeScrollAdjustment + r.scrollLeft) *
              ...
              t.scrollbarXActive
                ...
                : (r.classList.remove(L.state.active('x')),
                  (t.scrollbarXWidth = 0),
                  (t.scrollbarXLeft = 0),
                  (r.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
              t.scrollbarYActive
            ...
            H = {
              ...
              keyboard: function (t) {
                function i(i, n) {
                  ...
                  if (0 === i) {
                    ...
                    if (
                      (0 === o && 0 < n) ||
                      (o >= t.contentHeight - t.containerHeight && 0 > n)
                    )
                  ...
                  if (0 === n) {
                    ...
                    if (
                      (0 === l && 0 > i) ||
                      (l >= t.contentWidth - t.containerWidth && 0 < i)
                    )
                      return !t.settings.wheelPropagation
                  }
                  return !0
                ...
                var r = t.element,
                  ...
                  l = function () {
                    return (
                      o(t.scrollbarX, ':focus') || o(t.scrollbarY, ':focus')
                    )
                  }
                  ...
                  if (!l(t.target, i, s)) {
                    ...
                    r.settings.useBothWheelAxes
                      ? r.scrollbarYActive && !r.scrollbarXActive
                        ? (s
                            ? (a.scrollTop -= s * r.settings.wheelSpeed)
                            : (a.scrollTop += i * r.settings.wheelSpeed),
                          (c = !0))
                        : r.scrollbarXActive &&
                          !r.scrollbarYActive &&
                          (i
                            ? (a.scrollLeft += i * r.settings.wheelSpeed)
                            : (a.scrollLeft -= s * r.settings.wheelSpeed),
                          (c = !0))
                      : ((a.scrollTop -= s * r.settings.wheelSpeed),
                        (a.scrollLeft += i * r.settings.wheelSpeed)),
                      b(r),
              ...
              touch: function (r) {
                function n(i, n) {
                  ...
                  if (a > s) {
                    if (
                      (0 > n && o === r.contentHeight - r.containerHeight) ||
                      (0 < n && 0 === o)
                    )
                      return 0 === window.scrollY && 0 < n && R.isChrome
                  } else if (
                    s > a &&
                    ((0 > i && l === r.contentWidth - r.containerWidth) ||
                      (0 < i && 0 === l))
                  )
                    return !0
                  return !0
                ...
                if (R.supportsTouch || R.supportsIePointer) {
                  ...
                  R.supportsTouch
                    ...
                    : R.supportsIePointer &&
                      (window.PointerEvent
                        ? (r.event.bind(u, 'pointerdown', a),
                          r.event.bind(u, 'pointermove', h),
                          r.event.bind(u, 'pointerup', d))
                        : window.MSPointerEvent &&
                          (r.event.bind(u, 'MSPointerDown', a),
                          r.event.bind(u, 'MSPointerMove', h),
                          r.event.bind(u, 'MSPointerUp', d)))
                }
              },
            },
            k = function (t, o) {
              ...
              ;(this.scrollbarXBottom = parseInt(h.bottom, 10)),
                ...
                (this.railBorderXWidth =
                  f(h.borderLeftWidth) + f(h.borderRightWidth)),
                r(this.scrollbarXRail, { display: 'block' }),
                (this.railXMarginWidth = f(h.marginLeft) + f(h.marginRight)),
              ...
              ;(this.scrollbarYRight = parseInt(d.right, 10)),
                ...
                (this.railBorderYWidth =
                  f(d.borderTopWidth) + f(d.borderBottomWidth)),
                r(this.scrollbarYRail, { display: 'block' }),
                (this.railYMarginHeight = f(d.marginTop) + f(d.marginBottom)),
          ...
          return (
            ...
            (k.prototype.onScroll = function () {
              this.isAlive &&
                (b(this),
                u(this, 'top', this.element.scrollTop - this.lastScrollTop),
                u(this, 'left', this.element.scrollLeft - this.lastScrollLeft),
