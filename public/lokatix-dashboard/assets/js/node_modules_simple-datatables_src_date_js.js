;(self['webpackChunkmazer'] = self['webpackChunkmazer'] || []).push([
  ['node_modules_simple-datatables_src_date_js'],
  {
                ...
                h && (c = s[2]),
                  ...
                  (this.$d = (function (t, e, n) {
                    try {
                      ...
                      return c
                        ? new Date(
                            Date.UTC(M, Y, m, v, p, D, g + 60 * c.offset * 1e3)
                          )
                        : n
                        ? new Date(Date.UTC(M, Y, m, v, p, D, g))
                        : new Date(M, Y, m, v, p, D, g)
                    } catch (t) {
                      return new Date('')
                    }
                  })(e, a, r)),
  ...
  \****************************************************/
      /***/ (
        ...
        /* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! dayjs */ './node_modules/dayjs/dayjs.min.js')
        /* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default =
          /*#__PURE__*/ __webpack_require__.n(
            dayjs__WEBPACK_IMPORTED_MODULE_0__
          )
        /* harmony import */ var dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! dayjs/plugin/customParseFormat */ './node_modules/dayjs/plugin/customParseFormat.js'
          )
        /* harmony import */ var dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_1___default =
          /*#__PURE__*/ __webpack_require__.n(
            dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_1__
          )

        dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend(
          dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_1___default()
        )
        ...
        const parseDate = (content, format) => {
          ...
          if (format) {
            switch (format) {
              ...
              case 'UNIX':
                date =
                  dayjs__WEBPACK_IMPORTED_MODULE_0___default()(content).unix()
                break
