...
;(() => {
  var e,
    t = {
      ...
      44: (e, t, n) => {
        ...
        r.addEventListener('input', function (e) {
          ...
          document.addEventListener('DOMContentLoaded', function () {
            ...
            var storedTheme = localStorage.getItem(i)
              ...
              (r = [
                {
                  ...
                  value: function () {
                    ...
                    setTimeout(function () {
                      var e
                      return null ===
                        (e = document.querySelector('.sidebar-item.active')) ||
                        void 0 === e
                        ? void 0
                        : e.scrollIntoView(!1)
                    }, 100),
      ...
      797: (e, t, n) => {
        'use strict'
        n.r(t), n.d(t, { Sidebar: () => i }), (window.PerfectScrollbar = n(225))
        var i = n(750)
      },
      508: function (e) {
        var t
            ...
            return (function (e) {
              ...
              './node_modules/core-js/internals/array-from.js': function (
                ...
                e.exports = function (e) {
                  var t,
                    ...
                    g = c(h)
                  if (
                    (x && (f = i(f, y > 2 ? arguments[2] : void 0, 2)),
                    null == g || (u == Array && l(g)))
                  )
                    for (n = new u((t = a(h.length))); t > m; m++)
                      s(n, m, x ? f(h[m], m) : h[m])
                  else
                    for (d = g.call(h), n = new u(); !(p = d.next()).done; m++)
              ...
              './node_modules/core-js/internals/define-iterator.js': function (
                ...
                e.exports = function (e, t, n, p, u, b, w) {
                  ...
                  if (
                    ...
                    else i({ target: t, proto: !0, forced: f || H }, M)
                  return M
                }
              },
              ...
              './node_modules/core-js/internals/export.js': function (e, t, n) {
                ...
                e.exports = function (e, t) {
                  var n,
                    ...
                    x = e.stat
                  if (
                    (n = f ? i : x ? i[y] || a(y, {}) : (i[y] || {}).prototype)
                  )
                    for (p in t) {
                      if (
                        ((h = t[p]),
                        (d = e.noTargetGet ? (u = o(n, p)) && u.value : n[p]),
                        !c(f ? p : y + (x ? '.' : '#') + p, e.forced) &&
                          void 0 !== d)
                      ) {
                        if (typeof h == typeof d) continue
                        s(h, d)
                      }
                      ;(e.sham || (d && d.sham)) && r(h, 'sham', !0),
                        l(n, p, h, e)
                    }
                }
              },
              ...
              './node_modules/core-js/internals/native-weak-map.js': function (
                ...
                var i = n('./node_modules/core-js/internals/global.js'),
                  ...
                  r = i.WeakMap
                e.exports =
                  'function' == typeof r && /native code/.test(o.call(r))
              },
                ...
                o('inspectSource', function (e) {
                  ...
                  (e.exports = function (e, t, n, o) {
                    var s = !!o && !!o.unsafe,
                      ...
                      p = !!o && !!o.noTargetGet
                    'function' == typeof n &&
                      ('string' != typeof t || l(n, 'name') || r(n, 'name', t),
                      (d(n).source = h.join('string' == typeof t ? t : ''))),
                      e !== i
                        ? (s ? !p && e[t] && (c = !0) : delete e[t],
                          c ? (e[t] = n) : r(e, t, n))
                        : c
                        ? (e[t] = n)
                        : a(t, n)
                    ...
                    return (
                      ('function' == typeof this && p(this).source) ||
                      s.call(this)
                    )
                  })
              },
              ...
              './node_modules/core-js/modules/es.string.iterator.js': function (
                ...
                r(
                  ...
                  'String',
                  function (e) {
                    a(this, { type: l, string: String(e), index: 0 })
                  },
                  function () {
                    var e,
                      t = s(this),
        ...
        e.exports = (function () {
          ...
          function c(e, t) {
            _[t] = setTimeout(function () {
              return (
                e.isAlive && e.element.classList.remove(w.state.scrolling(t))
              )
          ...
          function h(e, t, n, i, o) {
            var r
            if (
              (void 0 === i && (i = !0), void 0 === o && (o = !1), 'top' === t)
            )
              r = [
                'contentHeight',
                'containerHeight',
            ...
            ;(e.reach[s] = null),
              ...
              t &&
                ...
                0 > t
                  ...
                  : 0 < t && u.dispatchEvent(d('ps-scroll-' + h)),
                i && p(e, s)),
              e.reach[s] &&
                (t || o) &&
                u.dispatchEvent(d('ps-' + s + '-reach-' + e.reach[s]))
          }
          function y(e) {
          ...
          function m(e) {
            ...
            ;(e.containerWidth = n(r.width)),
              ...
              i.contains(e.scrollbarXRail) ||
                (a(i, w.element.rail('x')).forEach(function (e) {
                  return l(e)
                }),
                i.appendChild(e.scrollbarXRail)),
              i.contains(e.scrollbarYRail) ||
                (a(i, w.element.rail('y')).forEach(function (e) {
                  return l(e)
                }),
          ...
          function j(e, t) {
            ...
            function o(t, o) {
              ;(g = x[u]),
                ...
                (j = (e[l] - e[r]) / (e[p] - e[h])),
                o
                  ? e.event.bind(e.ownerDocument, 'touchmove', n)
            ...
            S = {
              ...
              keyboard: function (e) {
                function n(n, o) {
                  ...
                  if (0 === n) {
                    ...
                    if (
                      (0 === r && 0 < o) ||
                      (r >= e.contentHeight - e.containerHeight && 0 > o)
                    )
                  ...
                  if (0 === o) {
                    ...
                    if (
                      (0 === l && 0 > n) ||
                      (l >= e.contentWidth - e.containerWidth && 0 < n)
                    )
                      return !e.settings.wheelPropagation
                  }
                  return !0
                ...
                var i = e.element,
                  ...
                  l = function () {
                    return (
                      r(e.scrollbarX, ':focus') || r(e.scrollbarY, ':focus')
                    )
                  }
                  ...
                  if (!l(e.target, n, a)) {
                    ...
                    i.settings.useBothWheelAxes
                      ? i.scrollbarYActive && !i.scrollbarXActive
                        ? (a
                            ? (s.scrollTop -= a * i.settings.wheelSpeed)
                            : (s.scrollTop += n * i.settings.wheelSpeed),
                          (c = !0))
                        : i.scrollbarXActive &&
                          !i.scrollbarYActive &&
                          (n
                            ? (s.scrollLeft += n * i.settings.wheelSpeed)
              ...
              touch: function (i) {
                function o(n, o) {
                  ...
                  if (s > a) {
                    if (
                      (0 > o && r === i.contentHeight - i.containerHeight) ||
                      (0 < o && 0 === r)
                    )
                      return 0 === window.scrollY && 0 < o && L.isChrome
                  } else if (
                    a > s &&
                    ((0 > n && l === i.contentWidth - i.containerWidth) ||
                      (0 < n && 0 === l))
                  )
                    return !0
                  return !0
                ...
                if (L.supportsTouch || L.supportsIePointer) {
                  ...
                  L.supportsTouch
                    ...
                    : L.supportsIePointer &&
                      (window.PointerEvent
                        ? (i.event.bind(h, 'pointerdown', s),
                          i.event.bind(h, 'pointermove', p),
                          i.event.bind(h, 'pointerup', d))
                        : window.MSPointerEvent &&
                          (i.event.bind(h, 'MSPointerDown', s),
                          i.event.bind(h, 'MSPointerMove', p),
                          i.event.bind(h, 'MSPointerUp', d)))
                }
              },
            },
            z = function (e, r) {
              ...
              ;(this.scrollbarXBottom = parseInt(p.bottom, 10)),
                ...
                (this.railBorderXWidth =
                  y(p.borderLeftWidth) + y(p.borderRightWidth)),
                i(this.scrollbarXRail, { display: 'block' }),
                (this.railXMarginWidth = y(p.marginLeft) + y(p.marginRight)),
              ...
              ;(this.scrollbarYRight = parseInt(d.right, 10)),
                ...
                (this.railBorderYWidth =
                  y(d.borderTopWidth) + y(d.borderBottomWidth)),
                i(this.scrollbarYRail, { display: 'block' }),
                (this.railYMarginHeight = y(d.marginTop) + y(d.marginBottom)),
      ...
      if (!n) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [n, o, r] = e[p], a = !0, s = 0; s < n.length; s++)
            (!1 & r || l >= r) && Object.keys(i.O).every((e) => i.O[e](n[s]))
              ? n.splice(s--, 1)
              : ((a = !1), r < l && (l = r))
          if (a) {
            e.splice(p--, 1)
